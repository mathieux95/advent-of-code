...
def part1(input_data: int) -> str:
    ...
    return "".join(map(str, recipes[input_data:input_data + 10]))
"""
...
def part2(input_data: str) -> int:
    ...
    while True:
        ...
        if recipes[-len(input_data):] == input_data:
            return len(recipes) - len(input_data)

        if recipes[-len(input_data) - 1:-1] == input_data:
            return len(recipes) - len(input_data) - 1
"""